...
import ShareFacebookButton from '@/app/components/ShareButton/ShareFacebookButton'; // ajusta el path si es necesario
// dentro del render:
...
export default async function NoticiaPage({ params }) {
  ...
  return (
    <main style={{ padding: '1rem' }}>
      ...
      <ShareFacebookButton url={`https://vivala21.vercel.app/noticias/${params.id}`} title={noticia.title.rendered} />
    </main>
  );
}